...
import { validateUserRegister } from "../middleware/validateRequest.js";
...
router.get("/", checkUserType(["administrador"]), userController.getAllUsers);
...
router.put("/:id", checkUserType(["administrador"]), userController.updateUser);
