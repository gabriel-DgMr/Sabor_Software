// import { MercadoPagoConfig, Preference } from "mercadopago"; // Deshabilitado - migrado a PayU
...
export const crearPreferencia = async (req, res) => {
  res.status(410).json({
    error: "Mercado Pago ha sido reemplazado por PayU",
    message:
      "Esta funcionalidad ha sido migrada a PayU. Usa /api/payu/formulario en su lugar.",
    migration_endpoint: "/api/payu/formulario",
  });
