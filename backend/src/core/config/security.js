...
export const securityConfig = {
  ...
  headers: {
    ...
    "Content-Security-Policy":
      "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: blob: https:; font-src 'self' data:; connect-src 'self' https://sabor-production.up.railway.app http://localhost:3000; form-action 'self' https://checkout.payulatam.com https://sandbox.checkout.payulatam.com;",
  },
...
export const SECURITY_CONSTANTS = {
  ...
  PERMISSIONS: {
    ...
    MANAGE_USERS_OWN: "manage_users_own",
  },
