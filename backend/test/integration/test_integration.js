...
class IntegrationTester {
    ...
    async checkDatabaseStructure() {
        ...
        const requiredColumns = ['id', 'tipo_usuario', 'nombre', 'email', 'password', 'telefono', 'imagen', 'activo'];
    ...
    async testUserRegistration() {
        ...
        const response = await axios.post(`${BASE_URL}/auth/register-cliente`, testUser);
    ...
    async runAllTests() {
        ...
        await this.log(`📊 Total: ${this.testResults.passed + this.testResults.failed}`);
