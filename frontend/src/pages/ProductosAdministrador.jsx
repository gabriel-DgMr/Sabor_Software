      ...
      <main className="productos__administrar">
        ...
        <section className="productos__grid">
          ...
          <article className="productos__editor">
            ...
            {successMessage && <ProductosAlert type="success" message={successMessage} />}
            <form className="editor__descripcion" onSubmit={handleSubmit}>
              ...
              <div className="descripcion__campo">
                ...
                <select
                  ...
                  onChange={handleInputChange}
                >
                  <option className="campo__input--option" value="">
                ...
                {errors.id_categoria_producto && (
                  <small className="formulario__mensaje-error">
                    {errors.id_categoria_producto}
                  </small>
                )}
                {categoriasError && (
              ...
              <div className="descripcion__campo">
                ...
                {imagePreview && (
                  <div className="image-preview-container">
                    <img alt="Vista previa" className="image-preview" src={imagePreview} />
                    <button className="remove-image-btn" type="button" onClick={handleRemoveImage}>
                      Eliminar imagen
                    </button>
                  </div>
                )}
